...
class ActivityLogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create activity_log" do
    assert_difference('ActivityLog.count') do
      post activity_logs_url, params: { activity_log: { action: @activity_log.action, ad_id: @activity_log.ad_id, click: @activity_log.click, user_id: @activity_log.user_id } }
    end
  ...
  test "should update activity_log" do
    patch activity_log_url(@activity_log), params: { activity_log: { action: @activity_log.action, ad_id: @activity_log.ad_id, click: @activity_log.click, user_id: @activity_log.user_id } }
